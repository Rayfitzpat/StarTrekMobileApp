...
public class Archer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.archervid);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.exit) {
            Intent i = new Intent(Archer.this, Captains.class);
            startActivity(i);
//            Toast.makeText(this, "Test 1", Toast.LENGTH_SHORT).show();
            ...
            Intent i = new Intent(Archer.this, Pike.class);
            startActivity(i);
