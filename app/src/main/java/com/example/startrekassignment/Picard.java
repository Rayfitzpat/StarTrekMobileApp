...
public class Picard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.picard);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.exit) {
            Intent i = new Intent(Picard.this, Captains.class);
            startActivity(i);
//            Toast.makeText(this, "Test 1", Toast.LENGTH_SHORT).show();
            ...
            Intent i = new Intent(Picard.this, Riker.class);
            startActivity(i);
...
//            Toast.makeText(this, "Test 1", Toast.LENGTH_SHORT).show();
            ...
            Intent i = new Intent(Picard.this, Spock.class);
            startActivity(i);
