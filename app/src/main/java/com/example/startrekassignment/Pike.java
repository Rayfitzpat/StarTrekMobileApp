...
public class Pike extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.pike);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.exit) {
            Intent i = new Intent(Pike.this, Captains.class);
            startActivity(i);
//            Toast.makeText(this, "Test 1", Toast.LENGTH_SHORT).show();
            ...
            Intent i = new Intent(Pike.this, Kirk.class);
            startActivity(i);
...
//            Toast.makeText(this, "Test 1", Toast.LENGTH_SHORT).show();
            ...
            Intent i = new Intent(Pike.this, Archer.class);
            startActivity(i);
